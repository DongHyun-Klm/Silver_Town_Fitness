...
VALUES ( '0', '수영(水泳, Swimming)', '수영은 물에서 나아가기 위해 손발을 움직이는 행위, 또는 물에서 누가 더 빨리 나가는지를 겨루는 스포츠이다.', '@/assets/수영_이미지2.jpg', '전신 운동: 수영은 전신을 균형있게 운동시키는데 도움이 됩니다. 팔, 다리, 등, 복부 등 다양한 근육을 사용하여 강화시킬 수 있습니다.
...
스트레스 완화: 수영은 수련 동안 수면 상태를 유지하고 스트레스를 감소시키는 데 도움이 됩니다.'),
 ( '0', '요가 (Yoga)', '요가는 몸과 마음을 조화롭게 가꾸는 몸과 정신의 종합 운동입니다. 몸의 유연성, 균형감각, 근력, 호흡, 집중력, 스트레스 관리 등 다양한 측면에서 건강에 도움을 줍니다. 요가는 다양한 자세와 동작을 수행하여 몸의 유연성을 향상시키고 몸과 마음의 안정을 증진시키는 데 초점을 둡니다.', '@/assets/요가_이미지2.jpg', '유연성 개선: 요가는 근육과 인대를 스트레칭하여 유연성을 향상시킵니다. 관절의 움직임을 개선하고 몸의 자세를 조정하는 데 도움이 됩니다.
...
강력한 핵근육: 요가 동작은 복부와 허리 근육을 강화하는 데 도움이 됩니다. 핵근육의 강화는 척추 안정성을 향상시키고 다른 운동에서의 성능을 향상시킵니다.'),
  ( '0', '게이트볼(Gateball)', '게이트볼은 공을 목표 게이트에 가까이 넣는 것을 목표로 하는 팀 경기입니다. 공을 원하는 위치에 정확하게 차고, 상대팀의 공을 방해하고 목표 게이트에 점수를 얻는 전략적인 게임입니다. 게이트볼은 노인들을 위한 사회 활동으로도 많이 즐겨지며, 건강한 신체 활동과 사회적 상호 작용을 도모합니다.', '@/assets/요가_이미지2.jpg', '사회적 상호작용: 게이트볼은 팀 스포츠로서 다른 사람들과 협력하고 소통하는 기회를 제공합니다. 사회적인 활동을 통해 친목을 도모할 수 있습니다.
...
적응력과 반사신경: 게이트볼은 공을 빠르게 인식하고 반응할 수 있는 반사 신경과 적응력을 향상시키는 데 도움이 됩니다.'),
   ( '0', '댄스 스포츠 (Dance Sports):', '댄스 스포츠는 음악과 함께 춤을 추는 스포츠입니다. 댄스 스포츠는 라틴 댄스와 볼룸 댄스로 구성되며, 커플 또는 그룹으로 참가하여 리듬과 스타일을 표현합니다. 댄스 스포츠는 몸의 유연성, 균형감각, 신체 조절, 협업 능력 등을 향상시키고, 운동량을 소모하여 체력을 향상시킵니다.','@/assets/수영_이미지2.jpg', '신체 조절 및 유연성: 댄스 스포츠는 몸의 운동 범위를 넓히고 유연성을 개발하는 데 도움이 됩니다. 자세와 균형을 개선하여 운동 성과를 향상시킵니다.
...
자기 표현과 창의성: 댄스 스포츠는 감정과 자기 표현을 표현하는 수단이 될 수 있습니다. 창의성을 발휘하고 예술적인 요소를 표현하는 데 도움이 됩니다.'),
    ( '0', '스쿼시 (Squash)', '스쿼시는 벽과 공을 이용하여 플레이하는 실내 라켓 스포츠입니다. 스쿼시는 두 명의 선수가 좁은 코트에서 공을 서로에게 튀어오르게 하며 플레이합니다. 스쿼시는 전신 운동으로 근력, 유연성, 반사 신경 등을 향상시키며, 빠른 움직임과 전략적인 플레이가 요구됩니다. 스쿼시는 빠른 속도와 집중력을 요구하므로 신체적인 피트니스와 전략적 사고를 발전시킵니다.', '@/assets/스쿼시_이미지2.jpg', '유산소 및 근력 운동: 스쿼시는 고강도의 유산소 운동으로 심폐 기능을 향상시키고 체력을 키울 수 있습니다. 또한, 스쿼시는 다리, 팔, 허리 근육을 강화하는 데 도움이 됩니다.
