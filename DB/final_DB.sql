...
VALUES ('0', "ikkid", "춘자씨", "안녕하세요. 저희 가족은 항상 당신을 생각하며 건강하고 행복하길 바랍니다. 최근들어 날씨가 점점 따뜻해지면서 봄의 기운을 느낄 수 있어 기분이 좋아지고 있어요. 저희 집 근처에는 예쁜 꽃들이 피어나고 나무들이 푸르게 물들고 있어서 매일 산책을 즐기고 있어요. 이번 주말에는 가족 모두 함께 소풍을 가기로 했어요. 여러분도 많이 웃고 즐거운 시간을 보내길 바라며, 항상 응원하고 있을게요!", NOW(), 127, 'love_1.jpg'),
       ('0', "ikkid", "안녕하세요", "잘 지내시나요? 얼마 전에 친구들과 함께 산에 등반을 다녀왔는데, 정말 멋진 경치를 볼 수 있었어요. 정상에서 내려다보니 세상이 정말 아름답고 작은 고민들도 사라지는 것 같았어요. 여러분도 가끔은 일상에서 벗어나서 자연과 함께하는 시간을 갖는 것을 추천해요. 그리고 저에게도 소식을 많이 알려주세요. 함께 이야기 나누는 시간이 저에게 큰 힘이 됩니다. 잘 지내고 행복한 일들 가득하시길 바라요!", NOW(), 24, 'love_2.jpeg'),
       ('0', "gyoid", "오랜만이군요", "오늘은 어떤 일이 있었나요? 지난 주에는 친구들과 함께 여행을 다녀왔어요. 새로운 장소를 방문하고 맛있는 음식을 먹으며 정말 즐거운 시간을 보냈어요. 그리고 이번 주에는 새로운 취미를 시작했어요. 그것은 그림 그리기인데요, 처음에는 어려워서 많이 막막했지만 조금씩 발전하고 있는 것 같아 기분이 좋아지고 있어요. 여러분도 새로운 도전을 하면서 자신감을 키워보는 것은 어떨까요? 기대됩니다! 잘 지내시고 즐거운 하루 보내세요!", NOW(), 25, 'love_3.jpg'),
       ('0', "ikkid", "만나서 반가워요. 연락하고싶어요 하하", "오랜만에 뵙게 되었네요! 최근들어 시간이 참 빠르게 흘러가는 것 같아요. 그래도 우리는 여전히 변하지 않고 함께 있어서 참 행복해요. 가끔은 서로에게 전화나 문자를 보내며 소식을 주고받으면서 더욱 더 가까워질 수 있을 것 같아요. 우리 다음에 만나면 좋은 추억들을 만들어보는 건 어떨까요? 기대돼요! 사랑합니다.", NOW(), 3, 'love_4.jpg'),
       ('0', "jayid", "존박-네생각", "오랜만에 인사드려요! 요즘은 여러 가지 일로 정신이 좀 바쁘지만 여전히 힘차게 살고 있어요. 매일 아침에는 간단한 운동을 하고 건강을 유지하려고 노력하고 있어요. 가끔은 나만의 시간을 갖고 책을 읽거나 영화를 보며 힐링하는 시간을 갖는 것도 좋아요. 여러분도 자신만의 작은 행복을 찾아보는 것은 어떨까요? 힘든 날도 있겠지만 언제나 응원하고 있을게요. 건강하고 행복한 하루 보내세요!", NOW(), 242, 'love_5.jpeg'),
       ('0', "rahid", "안녕하십니까", "오늘은 어떤 계획이 있으신가요? 시간이 빠르게 흘러가는데, 가끔은 한가로운 시간을 갖는 것도 좋을 것 같아요. 바쁜 일상에 휩쓸리지 말고 마음을 가라앉힐 수 있는 시간을 갖는 것이 중요하다고 생각해요. 그리고 저에게도 소식을 많이 알려주세요. 함께 이야기 나누는 시간이 저에게 큰 힘이 됩니다. 행복한 일들이 가득하길 바라요!", NOW(), 5, 'love_6.jpg'),
       ('0', "jayid", "반갑습니다", "오늘은 기분이 좋아요! 어제는 친구들과 함께 즐거운 시간을 보내고, 오늘은 좋아하는 음악을 들으며 여유롭게 보내고 있어요. 가끔은 자신에게 보상을 주는 것도 좋은 방법이라고 생각해요. 우리는 자주 힘들게 노력하는데, 그만큼 휴식과 재충전도 필요하다고 생각해요. 자신을 위한 작은 선물을 주면서 행복한 순간을 만들어보는 건 어떨까요? 기분 좋은 하루 보내세요!", NOW(), 33, 'love_7.jpg'),
       ('0', "soyid", "제 생각은 하나요", "잘 지내셨나요? 저는 요즘에 일이 정말 많아서 너무 바쁘네요. 하지만 그만큼 성취감도 크고 뿌듯한 기분도 들어요. 가끔은 바쁜 일상에 지칠 때도 있겠지만, 그래도 항상 앞으로 나아가려는 의지를 가지고 힘내고 있어요. 여러분도 자신의 목표에 한 발 한 발 다가가는 모습을 지켜보는 것도 좋을 것 같아요. 응원하고 있을게요! 행운을 빕니다.", NOW(), 223, 'love_8.jpg'),
       ('0', "rahid", "방가방가", "오늘은 무슨 일이 있었나요? 저는 최근에 새로운 취미를 찾았어요. 바로 요리인데요, 처음에는 많이 어려웠지만 조금씩 익숙해지고 있어요. 맛있는 음식을 만들어 먹으며 가족과 함께하는 시간은 참 행복한 시간이에요. 여러분도 가끔은 요리를 해보면서 자신의 솜씨를 키워보는 것은 어떨까요? 즐거운 하루 보내세요!", NOW(), 555, 'love_9.png'),
       ('0', "jayid", "안녕하세용가리~", "오늘도 화이팅하세요! 삶은 어려운 일들로 가득차지만, 우리는 항상 앞으로 나아가기 위해 노력하고 있어요. 힘들어도 포기하지 않고 꾸준히 나아가는 모습이 멋있어요. 저는 여러분의 노력을 응원하고 있을게요. 오늘도 최선을 다해 화이팅하세요! 행운을 빕니다.", NOW(), 45, 'love_10.png'),
         ('0', "ikkid", "자니", "잘 지내시나요? 얼마 전에 친구들과 함께 산에 등반을 다녀왔는데, 정말 멋진 경치를 볼 수 있었어요. 정상에서 내려다보니 세상이 정말 아름답고 작은 고민들도 사라지는 것 같았어요. 여러분도 가끔은 일상에서 벗어나서 자연과 함께하는 시간을 갖는 것을 추천해요. 그리고 저에게도 소식을 많이 알려주세요. 함께 이야기 나누는 시간이 저에게 큰 힘이 됩니다. 잘 지내고 행복한 일들 가득하시길 바라요!", NOW(), 345, 'love_2.jpeg'),
       ('0', "gyoid", "날씨가 순자씨 같아요~", "오늘은 어떤 일이 있었나요? 지난 주에는 친구들과 함께 여행을 다녀왔어요. 새로운 장소를 방문하고 맛있는 음식을 먹으며 정말 즐거운 시간을 보냈어요. 그리고 이번 주에는 새로운 취미를 시작했어요. 그것은 그림 그리기인데요, 처음에는 어려워서 많이 막막했지만 조금씩 발전하고 있는 것 같아 기분이 좋아지고 있어요. 여러분도 새로운 도전을 하면서 자신감을 키워보는 것은 어떨까요? 기대됩니다! 잘 지내시고 즐거운 하루 보내세요!", NOW(), 999, 'love_3.jpg');     
